...
def topOtherLocations(number=5):
...
def resolutionTime(): # Not really needed?
...
def topResponsiblePeople(number=5):
...
if __name__ == "__main__":
    topLocations() #working
    topOtherLocations() #working
    resolutionTime() #working
    topDepartments() #working
    topRequestors() #working
    topResponsiblePeople() #working